...
export default function GroupNavbar({setOpenFProfile}:Props) {

    const {gDp,gName} = useChat()
    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" sx={{backgroundColor:"#0d285b"}}>
        <Toolbar>
          ...
          <Avatar src={gDp || "/logo.png"} onClick={()=>setOpenFProfile(prev=>!prev)} sx={{marginRight:"10px",cursor:"pointer"}}/>
